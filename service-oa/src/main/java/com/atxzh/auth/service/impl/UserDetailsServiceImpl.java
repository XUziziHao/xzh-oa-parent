...
import com.atxzh.security.custom.CustomUser;
import com.atxzh.security.custom.UserDetailsService;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //根据用户id查询用户操作权限数据
        List<String> userPermsList= sysMenuService.findUserPermsById(sysUser.getId());
        //创建list集合，封装最终权限数据
